...
WebUI.verifyTextPresent('Log out', true, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/TestingRR/Thread/Page_Home  Thread Travel/a_Log out'))

WebUI.takeScreenshot()

WebUI.verifyTextPresent('Login', true, FailureHandling.STOP_ON_FAILURE)

url = WebUI.getUrl()

WebUI.verifyEqual(url, 'https://dev.graybox.velir.com/', FailureHandling.STOP_ON_FAILURE)
